...
abstract class Environment {
  ...
  static String get devdmpath => dotenv.env['DEV_BASE_URL'] ?? 'Dev Base URL Not Found';

  static String get proddmpath => dotenv.env['PROD_BASE_URL'] ?? 'Prod Base URL Not Found';

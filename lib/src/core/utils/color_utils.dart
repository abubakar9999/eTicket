...
class ColorUtils {
  ...
  static Color blueColor = const Color(0xFF0D3ADC);
  static Color greenColor = const Color(0xFF025726);
  static Color color1 = const Color(0xFFFFF9E6);
  static Color backGroundColor = const Color(0xFF0B2E4F);
  static Color cooking = const Color(0xFFEE8A1B);
  static Color foodReady = const Color(0xFF5B48D5);
  static Color paid = const Color(0xBF008F8F);
